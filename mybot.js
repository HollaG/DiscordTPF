...
client.on("ready", async() => {
    ...
    var rolesChannel = client.channels.cache.find(c => c.name == "roles")
...
client.on("message", message => {
    ...
    //     "information": "```This bot is running on a modified version of York's code. See website for details.\nhttps://anidiots.guide/. \n\nSource code for this bot is available on Github at https://github.com/HollaG/DiscordTPF```",
    //     "level": " ",
    //     "uptime": " ",  
    //     "server": " ",
    //     "twitch": " ",
